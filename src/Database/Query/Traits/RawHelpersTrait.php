...
trait RawHelpersTrait
{
    ...
    {
        return ($this->tablePrefixer ?? $this->connection->getTablePrefixer())->addTablePrefix($table);
    }
    ...
    {
        return ($this->tablePrefixer ?? $this->connection->getTablePrefixer())->addTablePrefixToColumn($column);
    }
    ...
    {
        return ($this->grammar ?? $this->connection->getDriver()->getGrammar())->quoteCompositeIdentifier($identifier);
    }
    ...
    {
        return ($this->grammar ?? $this->connection->getDriver()->getGrammar())->quoteIdentifier($identifier);
    }
    ...
    {
        return ($this->grammar ?? $this->connection->getDriver()->getGrammar())->escapeLikeWildcards($string);
    }
}
